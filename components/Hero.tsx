...
import CursorBlobBackground from "./CursorBlob";
...
const Hero = () => {
  ...
  return (
    <>
      {/* This adds the magic cursor-following blob background */}
      <CursorBlobBackground />

      <section className="relative min-h-[70vh] w-full bg-transparent dark:bg-gray-900 flex flex-col items-center justify-center text-center px-6 py-16">
      ...
      <div className="flex flex-col md:flex-row gap-4 mt-6">
        <Button onClick={() => router.push("/lost-items")} className="px-6 py-3 text-lg font-medium">
          Lost Items
        </Button>

        <Button onClick={() => router.push("/found")} variant="outline" className="px-6 py-3 text-lg font-medium">
          Found Items
        </Button>
      </div>
      ...
      <div className="mt-12 w-full max-w-4xl">
        ...
        <div className="flex flex-wrap items-center justify-center gap-6">
          {technologies.map((tech) => (
            <div key={tech.name} className="opacity-80 hover:opacity-100 transition">
